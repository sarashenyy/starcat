...
dir = '/home/shenyueyue/Projects/starcat/data/corner/logage7/'
...
sample_val = sample_val[sample_val['g'] <= 25.5]  # *need to add other filter
...
# debug
# lnlike_5p(theta_val, step, isoc_inst, h2h_cmd_inst, synstars_inst, sample_val, times)
