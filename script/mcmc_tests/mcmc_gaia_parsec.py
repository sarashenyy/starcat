...
# %%
h2h = lnlike_5p(theta, step, Pisoc_inst, h2h_cmd_inst, Psynstars_inst, n_stars, Pobservation, 5)
h2p = lnlike_5p(theta, step, Pisoc_inst, h2p_cmd_inst, Psynstars_inst, n_stars, Pobservation, 5)
print(h2h)
print(h2p)
...
# %%
likelihood_inst = h2h_cmd_inst
with Pool(10) as pool:
    sampler = emcee.EnsembleSampler(
        nwalkers, ndim, lnlike_5p,
        pool=pool,
        args=(step, Pisoc_inst, likelihood_inst, Psynstars_inst, n_stars, Pobservation, 5)
    )
    nburn = 2000
